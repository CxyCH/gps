...
from gps.agent.ros.agent_pedbot import AgentPedbot
...
EXP_DIR = BASE_DIR + '/../experiments/turtle_pedbod_example/'
...
x0s = [np.array([8.0, 13.0, 0.,	# Position x, y, z
							0., 0., 0., 1.,	# Quaternion w, z, (x, y?)
							0., 0., 0.,			# Linear Velocities
							0., 0., 0.])]		# Angular Velocities
reset_conditions = copy(x0s)
