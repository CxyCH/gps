...
from gps.algorithm.algorithm_plato import AlgorithmPLATO
from gps.algorithm.algorithm_plato import AlgorithmMDGPS
...
from gps.proto.gps_pb2 import MOBILE_POSITION, MOBILE_ORIENTATION, \
				...
				POSITION_NEAREST_OBSTACLE, PEDSIM_AGENT, PEDSIM_EXPERT_POLICY
...
SENSOR_DIMS = {
    ...
    PEDSIM_AGENT: 10*3,
	PEDSIM_EXPERT_POLICY: 2,
    ACTION: 2
}

BASE_DIR = '/'.join(str.split(gps_filepath, '/')[:-2])
EXP_DIR = BASE_DIR + '/../experiments/pedsim_plato_example/'

common = {
    'experiment_name': 'pedsim_plato_example' + '_' + \
...
agent = {
    ...
    'sim_goal_state' : [np.array([38., 2., 0.])],
    'render' : False,
	'max_agents': 10,
