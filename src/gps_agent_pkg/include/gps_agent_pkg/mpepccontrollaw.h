...
#ifndef TURTLEBOT_MPEPC_MPEPC_LOCAL_PLANNER_INCLUDE_MPEPC_LOCAL_PLANNER_CONTROL_LAW_H_
#define TURTLEBOT_MPEPC_MPEPC_LOCAL_PLANNER_INCLUDE_MPEPC_LOCAL_PLANNER_CONTROL_LAW_H_
...
namespace mpepc_local_planner
{
  ...
  struct ControlLawSettings
  {
    ...
    public:
      ...
      double m_W_TURN;           // Angular velocity for Goal tunning
  };
...
#endif /* TURTLEBOT_MPEPC_MPEPC_LOCAL_PLANNER_INCLUDE_MPEPC_LOCAL_PLANNER_CONTROL_LAW_H_ */
